...
class _RegisterPageState extends State<RegisterPage> {
                    ...
                    child: SignInButtonBuilder(
                      ...
                      onPressed: () async {
                        if (_formKey.currentState.validate()){
                          _register(); //kayıt oldu. değişken tanımladık.
                        }
                      },
                      text: 'Kayıt Ol',
                    ),
  ...
  void _register() async {
    try{
      ...
      //ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Merhaba, ${user.email}')));
